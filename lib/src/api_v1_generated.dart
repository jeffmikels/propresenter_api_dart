/// AUTOGENERATED ON 2022-04-21 22:30:57.227992
...
class ProApiWrapper {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> annoucementActiveTimelineOperation(String operation) async {
  ...
  Future<Stream?> announcementActiveTimelineStatusStream() async {
    String url = '/v1/announcement/active/timeline';
  ...
  Future<Stream?> audioPlaylistUpdateGetStream(String playlistId) async {
    String url = '/v1/audio/playlist/$playlistId/updates';
  ...
  Future<Stream?> captureStatusGetStream() async {
    String url = '/v1/capture/status';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> captureOperation(String operation) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> clearLayer(String layer) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> clearGroupDelete(String id) async {
    String url = '/v1/clear/group/$id';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> clearGroupIconSet(String id, String postBody) async {
    String url = '/v1/clear/group/$id/icon';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> clearGroupTrigger(String id) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> globalGroupTrigger(String id) async {
  ...
  Future<Stream?> libraryGetStream(String libraryId) async {
    String url = '/v1/library/$libraryId';
  ...
  Future<Stream?> lookGetCurrentStream() async {
    String url = '/v1/look/current';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> lookSetCurrent(Map postBody) async {
    String url = '/v1/look/current';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> lookDelete(String id) async {
    String url = '/v1/look/$id';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> lookTrigger(String id) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> macroDelete(String id) async {
    String url = '/v1/macro/$id';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> macroTrigger(String id) async {
  ...
  Future<Stream?> mediaPlaylistUpdateGetStream(String playlistId) async {
    String url = '/v1/media/playlist/$playlistId/updates';
  ...
  Future<Stream?> messageGetAllStream() async {
    String url = '/v1/messages';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> messaageDelete(String id) async {
    String url = '/v1/message/$id';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> messageTrigger(String id, List postBody) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> messageClear(String id) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> findMyMouse() async {
  ...
  Future<Stream?> playlistActiveGetStream() async {
    String url = '/v1/playlist/active';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> playlistPut(String playlistId, List postBody) async {
    String url = '/v1/playlist/$playlistId';
  ...
  Future<Stream?> presentationGetActiveStream() async {
    String url = '/v1/presentation/current';
  ...
  Future<Stream?> presentationGetSlideIndexStream() async {
    String url = '/v1/presentation/slideIndex';
  ...
  Future<Stream?> presentationGetChordChartUpdatesStream() async {
    String url = '/v1/presentation/chordChart/updates';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> presentationTrigger(String uuid) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> presentationTriggerCue(String uuid, int index) async {
  ...
  Future<Stream?> presentationActiveTimelineStatusStream() async {
    String url = '/v1/presentation/active/timeline';
  ...
  Future<Stream?> presentationFocusedTimelineStatusStream() async {
    String url = '/v1/presentation/focused/timeline';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> presentationActiveTimelineOperation(String operation) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> presentationFocusedTimelineOperation(String operation) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> presentationTimelineOperation(String uuid, String operation) async {
  ...
  Future<Stream?> propGetAllStream() async {
    String url = '/v1/props';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> propDelete(String id) async {
    String url = '/v1/prop/$id';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> propTrigger(String id) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> propClear(String id) async {
  ...
  Future<Stream?> stageMessageGetStream() async {
    String url = '/v1/stage/message';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> stageMessageShow(String postBody) async {
    String url = '/v1/stage/message';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> stageMessageHide() async {
    String url = '/v1/stage/message';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> stageLayoutMapSet(List postBody) async {
    String url = '/v1/stage/layoutMap';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> stageScreenLayoutSet(String id, String layoutId) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> stageLayoutDelete(String layoutId) async {
  ...
  Future<Stream?> layerStatusGetStream() async {
    String url = '/v1/status/layers';
  ...
  Future<Stream?> stageScreensStatusGetStream() async {
    String url = '/v1/status/stageScreens';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> stageScreensStatusSet(bool postBody) async {
    String url = '/v1/status/stageScreens';
  ...
  Future<Stream?> audienceScreensStatusGetStream() async {
    String url = '/v1/status/audienceScreens';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> audienceScreensStatusSet(bool postBody) async {
    String url = '/v1/status/audienceScreens';
  ...
  Future<Stream?> statusScreensGetStream() async {
    String url = '/v1/status/screens';
  ...
  Future<Stream?> slideStatusGetStream() async {
    String url = '/v1/status/slide';
  ...
  /// }
  /// ```
  Future<Stream?> statusUpdatesGet(List postBody) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> themeSlideSet(String id, Map postBody, {String? themeSlide}) async {
    String url = '/v1/theme/$id/slides/$themeSlide';
  ...
  Future<Stream?> timerGetAllStream() async {
    String url = '/v1/timers';
  ...
  Future<Stream?> timerGetCurrentTimesStream() async {
    String url = '/v1/timers/current';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> timerDelete(String id) async {
    String url = '/v1/timer/$id';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> timerOperation(String id, String operation) async {
  ...
  Future<Stream?> timerGetSystemTimeStream() async {
    String url = '/v1/timer/systemTime';
  ...
  Future<Stream?> timerGetVideoCountdownStream() async {
    String url = '/v1/timer/videoCountdown';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> transportPlay(String layer) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> transportPause(String layer) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> transportSkipBackward(String layer, int time) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> transportSkipForward(String layer, int time) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> transportGoToEnd(String layer, {int? time}) async {
  ...
  Future<Stream?> transportTimeGetStream(String layer) async {
    String url = '/v1/transport/$layer/time';
  ...
  /// content-type: ``
  ///
  Future<Uint8List> transportTimeSet(String layer, double postBody) async {
    String url = '/v1/transport/$layer/time';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> transportAutoAdvanceCancel(String layer) async {
    String url = '/v1/transport/$layer/autoAdvance';
  ...
  Future<Stream?> transportCurrentMediaGetStream(String layer) async {
    String url = '/v1/transport/$layer/current';
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerCue(int index) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerPlaylist(String playlistId, String itemId, int cueIndex) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerMedia(String playlistId, String itemId) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerMediaNext() async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerMediaPrevious() async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> triggerAudio(String playlistId, String itemId) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerAudioNext() async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerAudioPrevious() async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerVideoInput(String id) async {
  ...
  /// content-type: ``
  ///
  Future<Uint8List> triggerLibrary(String libraryId, String presentationId, int index) async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerNext() async {
  ...
  /// content-type: `NONE`
  ///
  Future<Uint8List> triggerPrevious() async {
